...
Already Created Account? <a href="../student/stdent.php" class="ml-2 text-white">Sign In</a>
</div>
</div>
<?php
// }
...
<?php
	...
	if($su_dob == $su_retype_dob)
	{
		...
		?>
		<script> location.assign("student-signup.php?sign-up=1&registered=1")</script>
		<?php

	}else{
		?>
		<script> location.assign("student-signup.php?sign-up=1&invalid=1")</script>
	<?php
	}
}